...
router.get("/assignedflights", middleware.checkCrew, function (req, res) {
  var sql =
    "SELECT flight.flight_number,departure_date,departure_time,arrival_date,arrival_time, ap_des.airport_name as des_name, " +
  ...
  connection.query(sql, req.session.userid, function (err, result, fields) {
    res.render("./crew/assignedflights", { data: result });
  });
});
