...
router.get("/showflights", middleware.checkAdmin, function (req, res) {
    var sql = " select duration, flight_number,departure_date,departure_time,arrival_date,arrival_time, " +
...
router.get("/showflights/:flight", middleware.checkAdmin, function (req, res) {
    ...
    sql = "SELECT duration, flight.flight_number,departure_date,departure_time,arrival_date,arrival_time, ap_des.airport_name as des_name, " +
